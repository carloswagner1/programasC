...
#include <string.h>
#include <stdlib.h>
#include <unistd.h>//programa pausar por alguns segundos
...
void comprarProduto(){
    if(contador_produto > 0){
        printf("Informe o produto que deseja adicionar ao carrinho.\n");
...
int * temNoCarrinho(int codigo){
    ...
    for(int i = 0; i < contador_carrinho; i++){
        if(carrinho[i].produto.codigo == codigo){
            retorno[0] = 1; //tem produto com este código no carrinho
